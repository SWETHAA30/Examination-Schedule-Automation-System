function generateBatch() {
    ...
    if (!department) {
        department = 'CSE' + (111621102000 + Math.floor(Math.random() * 10));
    }
    ...
    for (var i = 1; i <= numberOfBatches; i++) {
        var startNumber = 111621102000 + (i - 1) * studentsPerBatch + 1;
        var endNumber = Math.min(startNumber + studentsPerBatch - 1, 111621102000 + totalStudents);
